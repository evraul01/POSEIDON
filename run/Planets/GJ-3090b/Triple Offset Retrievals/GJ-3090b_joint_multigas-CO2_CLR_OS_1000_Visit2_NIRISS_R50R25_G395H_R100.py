...
#data_included = 'G395H_Combined'
data_included = 'Visit2_NIRISS_R50R25_G395H_R100'
...
model_name = 'joint_multigas-CO2_CLR_OS_1000_' + data_included
#model_name = 'joint_multigas-PH3_200_' + data_included

param_species = ['H2O', 'CH4', 'CO', 'HCN', 'NH3', 'H2S', 'SO2']
...
if ('Visit1_NIRISS_R50R25' in data_included):
    datasets.append(planet_name + '_NIRISS_SOSS_Ord2_Visit1_R50R25.dat')
    datasets.append(planet_name + '_NIRISS_SOSS_Ord1_Visit1_R50R25.dat')
    instruments.append('JWST_NIRISS_SOSS_Ord2')
    instruments.append('JWST_NIRISS_SOSS_Ord1')
    if ('G395H' in data_included):
        #datasets.append(planet_name + '_NIRSpec_G395H_Combined.dat')
        datasets.append(planet_name + '_NIRSpec_G395H_NRS1_Visit1_R100.dat')
        datasets.append(planet_name + '_NIRSpec_G395H_NRS2_Visit1_R100.dat')
        instruments.append('JWST_NIRSPec_G395H_NRS1')
        instruments.append('JWST_NIRSPec_G395H_NRS2')
elif ('Visit1_NIRISS_R100' in data_included):
    datasets.append(planet_name + '_NIRISS_SOSS_Ord2_Visit1_R100.dat')
    datasets.append(planet_name + '_NIRISS_SOSS_Ord1_Visit1_R100.dat')
    instruments.append('JWST_NIRISS_SOSS_Ord2')
    instruments.append('JWST_NIRISS_SOSS_Ord1')
    if ('G395H' in data_included):
        #datasets.append(planet_name + '_NIRSpec_G395H_Combined.dat')
        ...
        instruments.append('JWST_NIRSPec_G395H_NRS1')
        instruments.append('JWST_NIRSPec_G395H_NRS2')
elif ('Visit2_NIRISS_R50R25' in data_included):
    datasets.append(planet_name + '_NIRISS_SOSS_Ord2_Visit2_R50R25.dat')
    datasets.append(planet_name + '_NIRISS_SOSS_Ord1_Visit2_R50R25.dat')
    instruments.append('JWST_NIRISS_SOSS_Ord2')
    instruments.append('JWST_NIRISS_SOSS_Ord1')
    if ('G395H' in data_included):
        #datasets.append(planet_name + '_NIRSpec_G395H_Combined.dat')
        datasets.append(planet_name + '_NIRSpec_G395H_NRS1_Visit2_R100.dat')
        datasets.append(planet_name + '_NIRSpec_G395H_NRS2_Visit2_R100.dat')
        instruments.append('JWST_NIRSPec_G395H_NRS1')
        instruments.append('JWST_NIRSPec_G395H_NRS2')
elif ('Visit2_NIRISS_R100' in data_included):
    datasets.append(planet_name + '_NIRISS_SOSS_Ord2_Visit2_R100.dat')
    datasets.append(planet_name + '_NIRISS_SOSS_Ord1_Visit2_R100.dat')
    instruments.append('JWST_NIRISS_SOSS_Ord2')
    instruments.append('JWST_NIRISS_SOSS_Ord1')
    if ('G395H' in data_included):
        #datasets.append(planet_name + '_NIRSpec_G395H_Combined.dat')
...
data = load_data(data_dir, datasets, instruments, wl,
                 offset_1_datasets = [datasets[1]],
                 offset_2_datasets = [datasets[2]],
                 offset_3_datasets = [datasets[3]],
                 )
...
if ('joint' in model_name):
    ...
    data_colour_list = ['crimson']
    data_labels = ['NIRSpec G395H']
    data_marker_list = ['o']
...
#    plt_label = 'Flat'
# elif ((('OS' in model_name) or ('TS' in model_name)) and ('atmosphere_clear' in model_name)):
#    plt_label = 'TLS + Clear Atmosphere'
# elif ((('OS' in model_name) or ('TS' in model_name)) and ('atmosphere_cloudy' in model_name)):
#    plt_label = 'TLS + Cloudy Atmosphere'
# elif ('atmosphere_clear' in model_name):
#    plt_label = 'Clear Atmosphere'
# elif ('atmosphere' in model_name):
#    plt_label = 'Cloudy Atmosphere'
# elif (('OS' in model_name) or ('TS' in model_name)):
#    plt_label = 'TLS Only'
