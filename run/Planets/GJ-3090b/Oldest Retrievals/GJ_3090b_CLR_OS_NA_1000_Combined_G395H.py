...
wl_min = 2.85      # Minimum wavelength (um)           2.8
wl_max = 5.10      # Maximum wavelength (um)           5.3
...
model_name = 'CLR_OS_NA_1000_Combined_' + data_included

bulk_species = ['CO2']     # H2 + He comprises the bulk atmosphere
...
model = define_model(model_name, bulk_species, param_species, 
                     ...
                     stellar_contam = 'one_spot', disable_atmosphere = True
                     )
