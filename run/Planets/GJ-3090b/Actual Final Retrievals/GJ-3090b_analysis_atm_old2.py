...
# planet_best = create_planet(planet_name, R_p = R_p_ref, mass = M_p, T_eq = T, d = d)
# print("Done Creating Planet!")

atmosphere_best = get_retrieved_atmosphere(planet_name, model, P, P_ref_set = P_ref, R_p_ref_set = R_p_ref)
