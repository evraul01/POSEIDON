...
data_included = 'NIRISS_Visit1_G395H'
...
model_name = 'joint_multigas_CLR_TS_200_' + data_included
#model_name = 'joint_multigas-PH3_200_' + data_included

param_species = ['H2O', 'CH4', 'CO', 'CO2', 'SO2']
...
if ('NIRISS' in data_included):
    ...
    datasets.append(planet_name + '_NIRISS_SOSS_Ord2_Visit1.dat')
    datasets.append(planet_name + '_NIRISS_SOSS_Ord1_Visit1.dat')
...
data = load_data(data_dir, datasets, instruments, wl,
                 offset_datasets = [planet_name + '_NIRSpec_G395H_NRS1.dat', planet_name + '_NIRSpec_G395H_NRS2.dat'])
...
prior_ranges['delta_rel_1'] = [-500, +500]
prior_ranges['delta_rel_2'] = [-500, +500]
