...
model_name = 'multigas_new_OS_2000_' + data_included
...
atmosphere_best = get_retrieved_atmosphere(planet, model, P, P_ref_set = P_ref, verbose = True)
...
spectrum_final = spectrum_best * epsilon_best

# Write to file
spectrum_file = write_spectrum(planet_name, model_name, spectrum_final, wl)