...
data_included = 'NIRISS_NIRSpec_Offset_Stacked_Mean'
...
model_name = '-CH4_Gauss_low-P-ref_TS_2000_' + data_included
#model_name = 'joint_multigas-PH3_200_' + data_included

param_species = ['H2O', 'CO', 'NH3', 'CO2', 'SO2']
...
if 'NIRISS_NIRSpec' in model_name:
