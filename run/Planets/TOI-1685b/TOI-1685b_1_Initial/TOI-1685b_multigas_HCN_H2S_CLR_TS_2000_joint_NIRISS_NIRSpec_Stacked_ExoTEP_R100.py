...
data_included = 'joint_NIRISS_NIRSpec_Stacked_ExoTEP_R100'
...
model_name = 'multigas_HCN_H2S_CLR_TS_2000_' + data_included
#model_name = 'joint_multigas-PH3_200_' + data_included

param_species = ['H2O', 'CH4', 'CO', 'NH3', 'CO2', 'SO2', 'HCN', 'H2S']
