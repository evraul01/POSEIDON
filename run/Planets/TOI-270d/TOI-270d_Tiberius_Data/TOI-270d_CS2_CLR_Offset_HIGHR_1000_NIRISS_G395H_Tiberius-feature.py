...
#data_included = 'G395H'
data_included = 'NIRISS_G395H_Tiberius-feature'

#***** Model wavelength grid *****#

wl_min = 0.58      # Minimum wavelength (um)           2.8
wl_max = 5.30      # Maximum wavelength (um)           5.3
R = 60000          # Spectral resolution of grid
...
model_name = 'CS2_CLR_Offset_HIGHR_1000_' + data_included

bulk_species = ['H2', 'He']     # H2 + He comprises the bulk atmosphere

param_species = ['H2O', 'CH4', 'CO2', 'SO2', 'CO', 'NH3', 'CS2']
...
prior_ranges['delta_rel_3'] = [-500, +500]
