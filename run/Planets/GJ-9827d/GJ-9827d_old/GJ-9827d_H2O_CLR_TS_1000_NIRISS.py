...
model_name = 'H2O_CLR_TS_1000_' + data_included

bulk_species = ['H2O']     # H2 + He comprises the bulk atmosphere

param_species = []

#flat line, one_spot/no atmosphere, two spots/no atmoosphere, only H2O atmosphere, multigas atmosphere, multigas atmosphere without H2O, multigas with one spot, multigas without H2O with one spot, multigas with two spots, multigas without H2O with two spots (multigas: bulk H2/He, param N2, Na, K, HCN, H2O, CO, CO2, CH4, NH3, H2S)
