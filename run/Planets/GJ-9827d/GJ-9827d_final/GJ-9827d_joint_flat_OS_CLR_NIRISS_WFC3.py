...
model_name = 'joint_flat_OS_CLR_' + data_included
#model_name = 'joint_atmosphere-H2O_TS_CLR_' + data_included
#model_name = 'joint_atmosphere_OS_CLR_' + data_included
...
if ('atmosphere' in model_name):

   bulk_species = ['H2', 'He']     # H2 + He comprises the bulk atmosphere

   param_species = ['N2', 'Na', 'K', 'HCN', 'H2O', 'CO', 'CO2', 'CH4', 'NH3', 'H2S']
...
if ('NIRISS' in data_included):
    if ('WFC3 in data_included'):
      data_colour_list = ['royalblue', 'forestgreen', 'black']
      data_labels = ['NIRISS SOSS (Ord 2)', 'NIRISS SOSS (Ord 1)', 'WFC3 G141']
...
#    plt_label = 'Flat'
# elif (('TLS' in model_name) and ('atmosphere_clear' in model_name)):
#    plt_label = 'TLS + Clear Atmosphere'
# elif (('TLS' in model_name) and ('atmosphere_cloudy' in model_name)):
