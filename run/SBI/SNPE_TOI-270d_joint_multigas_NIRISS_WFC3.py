...
do_retrieval = True
retrieval_algorithm = 'sbi'   # Options: 'MultiNest' or 'sbi'
do_sbi_postprocess_only = True  # True -> reuse SBI_raw samples, skip SBI rounds
...
model_name = 'SNPE' + '_joint_multigas_' + data_included
...
sbi_round_sizes = (12000, 8000, 8000)
...
if (do_retrieval == True):
    ...
    if (retrieval_algorithm.lower() == 'sbi'):
...
pairplot_from_saved_samples = True

if (retrieval_algorithm.lower() == 'sbi') and (do_sbi_postprocess_only == True):
