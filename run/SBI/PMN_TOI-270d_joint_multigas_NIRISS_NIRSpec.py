...
do_retrieval = True
# do_retrieval = False
retrieval_algorithm = 'pmn'   # Options: 'MultiNest', 'sbi', 'npe', 'snpe', 'npe_c', 'snpe_c', 'npe_a', 'snpe_a', 'fmpe', 'npse', 'nle', 'snle', 'nle_a', 'snle_a', 'nre', 'snre', 'nre_a', 'snre_a', 'nre_b', 'snre_b', 'nre_c', 'snre_c', or 'bnre'
