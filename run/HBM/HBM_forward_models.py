...
#     if Gauss_scatter == True:
#         datasets_new = [planet_name + '_SYNTHETIC_JWST_NIRISS_SOSS_Ord2_' + model_name + '_N_trans_' + str(N_trans[0]) + '.dat',
#                         planet_name + '_SYNTHETIC_JWST_NIRISS_SOSS_Ord1_' + model_name + '_N_trans_' + str(N_trans[1]) + '.dat',
#                         planet_name + '_SYNTHETIC_JWST_NIRSpec_G395H_NRS1_' + model_name + '_N_trans_' + str(N_trans[2]) + '.dat',
#                         planet_name + '_SYNTHETIC_JWST_NIRSpec_G395H_NRS2_' + model_name + '_N_trans_' + str(N_trans[3]) + '.dat']
#     else:
#         datasets_new = [planet_name + '_SYNTHETIC_JWST_NIRISS_SOSS_Ord2_' + model_name + '_N_trans_' + str(N_trans[0]) + '.dat',
#                     planet_name + '_SYNTHETIC_JWST_NIRISS_SOSS_Ord1_' + model_name + '_N_trans_' + str(N_trans[1]) + '.dat',
#                     planet_name + '_SYNTHETIC_JWST_NIRSpec_G395H_NRS1_' + model_name + '_N_trans_' + str(N_trans[2]) + '.dat',
