...
#data_included = 'G395H'
data_included = 'NIRISS_NIRSpec'
Gauss_scatter = True
if Gauss_scatter:
    data_type = '_Gaussian'
else:
    data_type = '_Non-Gaussian'
...
model_name = 'HBM_joint_H2_H2O_CLR_400_' + str(model_num) + data_type
...
planet_name = 'TOI-270n'

R_p = 2.133*R_E     # Planetary radius (m)
# M_p = 4.78*M_E      # Planet mass
masses = np.logspace(np.log10(2),np.log10(20),10)
M_p = masses[model_num]*M_E
...
fig_spec = plot_spectra_retrieved(spectra_median, spectra_low2, spectra_low1, 
                                ...
                                plt_label = model_name + '(' + str(round(masses[model_num],2)) + ' M⊕)',
